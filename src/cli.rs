...
pub enum Commands {
    ...
    Show {
        ...
        #[arg(
            long,
            help = "Show detailed task information including notes and dependencies"
        )]
        detailed: bool,
    ...
    Add {
        ...
        #[arg(
            long,
            value_name = "TAGS",
            help = "Comma-separated tags (e.g., backend,urgent)"
        )]
        tag: Option<String>,
        ...
        #[arg(
            long,
            value_name = "PHASE",
            help = "Phase name (e.g., mvp, beta, release, future, backlog, or custom name)"
        )]
        phase: Option<String>,
        ...
        #[arg(
            long,
            value_name = "NOTES",
            help = "Detailed notes or description for the task"
        )]
        note: Option<String>,
        ...
        #[arg(
            long = "depends-on",
            value_name = "TASK_IDS",
            help = "Comma-separated task IDs this task depends on"
        )]
        ...
        #[arg(
            long,
            value_name = "HOURS",
            help = "Estimated time to complete the task in hours (e.g., 2.5)"
        )]
    ...
    Quick {
        ...
        #[arg(
            value_name = "TEXT",
            help = "Natural language task (e.g., 'Fix login bug high priority backend tomorrow')"
        )]
        text: String,
    },
    ...
    Reset {
        ...
        #[arg(
            value_name = "TASK_ID",
            help = "The ID number of the task to reset (optional - resets all if not provided)"
        )]
        id: Option<usize>,
    },
    ...
    List {
        ...
        #[arg(
            long,
            value_name = "TAGS",
            help = "Show only tasks with these tags (comma-separated)"
        )]
        tag: Option<String>,
        ...
        #[arg(
            long,
            value_name = "STATUS",
            help = "Filter by status: pending, completed, all"
        )]
        ...
        #[arg(
            long,
            value_name = "QUERY",
            help = "Search for text in task descriptions and notes"
        )]
    ...
    Dependencies {
        ...
        #[arg(
            long,
            value_name = "TASK_ID",
            help = "Show dependency tree for a specific task"
        )]
    ...
    Find {
        ...
        #[arg(
            value_name = "QUERY",
            help = "Search query to find tasks (e.g., 'auth' finds 'authentication')"
        )]
        query: String,
    },
    ...
    Export {
        ...
        #[arg(
            long,
            value_name = "DATE",
            help = "Include only tasks created after this date (YYYY-MM-DD)"
        )]
        ...
        #[arg(
            long,
            value_name = "DATE",
            help = "Include only tasks created before this date (YYYY-MM-DD)"
        )]
        ...
        #[arg(
            long,
            value_name = "HOURS",
            help = "Include only tasks with estimated hours greater than this value"
        )]
        ...
        #[arg(
            long,
            value_name = "HOURS",
            help = "Include only tasks with estimated hours less than this value"
        )]
        ...
        #[arg(
            long,
            value_name = "HOURS",
            help = "Include only tasks with actual hours greater than this value"
        )]
        ...
        #[arg(
            long,
            value_name = "HOURS",
            help = "Include only tasks with actual hours less than this value"
        )]
        ...
        #[arg(
            long,
            help = "Include only tasks that have time tracking data (estimates or actual time)"
        )]
        with_time_data: bool,
        ...
        #[arg(
            long,
            help = "Include only tasks with currently active time tracking sessions"
        )]
    ...
    Start {
        ...
        #[arg(
            value_name = "TASK_ID",
            help = "The ID number of the task to start time tracking"
        )]
        id: usize,
        ...
        #[arg(
            ...
            help = "Description of what will be worked on during this session"
        )]
    ...
    Time {
        ...
        #[arg(
            value_name = "TASK_ID",
            help = "Show time information for a specific task"
        )]
        task_id: Option<usize>,
    ...
    Timeline {
        ...
        #[arg(
            ...
            short,
            value_name = "PAGE",
            help = "Page number for pagination (shows 5 phases per page)"
        )]
        page: Option<usize>,
        ...
        #[arg(
            long,
            value_name = "SIZE",
            help = "Number of phases to show per page (default: 5)"
        )]
    ...
    Interactive {
        ...
        #[arg(
            long,
            help = "Skip the welcome screen and go directly to the interface"
        )]
        no_welcome: bool,
    },
    ...
    Sync {
        ...
        #[arg(
            long,
            help = "Update Rask state from changes in the original roadmap file"
        )]
        from_roadmap: bool,
